...
namespace DiffMatchPatch
{
    ...
    public class diff_match_patch
    {
        ...
        public enum PatchResult
        {
            ...
            APPLIED_IMPERFECT,
            CONTENT_NOT_FOUND,
            LEADING_CONTEXT_NOT_MATCHED,
            CONTENT_TOO_DIFFERENT,
            TRAILING_CONTEXT_NOT_MATCHED
        }
        ...
        public Object[] patch_apply(List<Patch> patches, string text)
        {
            ...
            foreach (Patch aPatch in patches)
            {
                ...
                if (text1.Length > this.Match_MaxBits)
                {
                    ...
                    if (start_loc != -1)
                    {
                        ...
                        if (end_loc == -1 || start_loc >= end_loc)
                        {
                            ...
                            start_loc = -1;
                            resultCodes[x] = PatchResult.TRAILING_CONTEXT_NOT_MATCHED;
                        }
                    }
                    else
                    {
                        resultCodes[x] = PatchResult.LEADING_CONTEXT_NOT_MATCHED;
                    }
                }
                else
                {
                    ...
                    if (start_loc == -1)
                    {
                        resultCodes[x] = PatchResult.CONTENT_NOT_FOUND;
                    }
                }
                if (start_loc == -1)
                {
                ...
                else
                {
                    ...
                    if (text1 == text2)
                    {
                        ...
                        resultCodes[x] = PatchResult.APPLIED_PERFECT;
                    }
                    else
                    {
                            ...
                            > this.Patch_DeleteThreshold)
                        {
                            ...
                            results[x] = false;
                            resultCodes[x] = PatchResult.CONTENT_TOO_DIFFERENT;
                        }
                        else
                        {
                            diff_cleanupSemanticLossless(diffs);
                            ...
                            resultCodes[x] = PatchResult.APPLIED_IMPERFECT;
                        }
                    }
                }
                x++;
            ...
            return new Object[] { text, results, resultCodes };
        }
